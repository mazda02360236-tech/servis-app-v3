...
class ServiceApp(QMainWindow):
    def __init__(self):
        ...
        # Подсветка всей строки слева направо
    ...
    def get_status_style(self, status):
        styles = {
            "В роботі": "background-color: #d4edda; color: #155724; font-weight: bold; padding: 2px;",
            "Готово": "background-color: #cce5ff; color: #004085; font-weight: bold; padding: 2px;",
            "Видано": "background-color: #e2e3e5; color: #383d41; font-weight: bold; padding: 2px;",
            "Очікує запчастини": "background-color: #fff3cd; color: #856404; font-weight: bold; padding: 2px;",
            "Відмова": "background-color: #f8d7da; color: #721c24; font-weight: bold; padding: 2px;",
        }
    ...
    def load_orders(self):
        ...
        for row_idx, row_data in enumerate(rows):
            ...
            # Колонка 6: СТАТУС (QComboBox прямо в ячейке)
            ...
            # Подключение изменения статуса прямо в таблице
            ...
            # Колонка 7: ФОТО (кликом сразу открываем окно)
    ...
    def on_status_changed(self, order_id, new_status, row_idx, combo):
        ...
        # Мгновенное сохранение нового статуса в базу данных
        conn = sqlite3.connect(self.db_name)
        cursor = conn.cursor()
    ...
    def on_cell_clicked(self, row, column):
        ...
        if column == 7:
            ...
            if photo_path and os.path.exists(photo_path):
                ...
                QMessageBox.information(self, "Інформація", "До цього замовлення немає доданого фото.")
